...
const MuzmurPage: React.FC<MuzmurPageProps> = ({ isAuthorized }) => {
  ...
  // Logic: Meskerem (0) through Tahsas (3) are 2025/26. Tir (4) onwards are 2026.
  const displayGregorianYear = currentMonthIdx <= 3 ? '2025/26' : '2026';
      ...
      <div className="flex flex-col items-center space-y-8 py-4">
        ...
        <div className="w-full max-w-4xl text-center border-t border-[#d6c7a1]/30 pt-4">
           <p className="text-[#c5a059] font-serif italic text-lg">
            Explore sacred muzmurs and sacred feasts for the month of {selectedMonth.name}.
           </p>
        </div>
      </div>

      {/* VIEW 2: Major Events Selection */}
      {!selectedEvent && (
